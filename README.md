...
-*teste pesquisa cliente inexistente*
-*teste remove cliente*
-*teste remove cliente inexistente*
-*teste idade aceitavel*
-*teste idade não permitida* teste de limite 
https://github.com/luizcarvalho2/exercicio-01.git
 ## Sobre mim- 
 Sou estudante de engenharia de software e estou estudando automação de testes de software. 
